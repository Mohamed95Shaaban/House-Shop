<%-- 
    Document   : SpaceficSearch
    Created on : Dec 18, 2017, 4:12:51 PM
    Author     : Antr
--%>
    ...
    <body>
       ...
       <div class="header">  
        ...
        <div id="Container">
            ...
            String ColumnName = request.getParameter("property");
            
            
            String value = request.getParameter("searchQury");
            
            
                Statement Stmt = Con.createStatement();
                ResultSet adv = Stmt.executeQuery("SELECT * FROM advertisment WHERE "+ColumnName+" = '"+value+"'");
                while(adv.next()){
